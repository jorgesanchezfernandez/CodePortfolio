...
public final class VistaAnimalesxCentro_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>Vista de animales por centro</title>\n");
      out.write("</head>\n");
      out.write("<body>\r\n");
      out.write("<div>\r\n");
      out.write("\t");
	...
	if(centroID!=null && 0<centroID.length()){
		Centro centro=CentroStore.getInstance().getCentro(centroID);
		if(centro.getAnimales()!=null){
			AnimalStore.getInstance();
			Iterator it=centro.getAnimales().iterator();
