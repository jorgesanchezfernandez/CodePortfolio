...
namespace PholioVisualisation.Export.FileBuilder.Wrappers
{
    public class OnDemandQueryParametersWrapper
    {
        ...
        public OnDemandQueryParametersWrapper(int profileId, IList<int> indicatorIds, 
            IDictionary<int, IList<Inequality>> inequalities, IList<string> childAreaCodeList = null, IList<int> groupListIds = null,
        ...
        public static Dictionary<int, IList<Inequality>> GetInequalitiesParameter(IList<int> indicatorIds)
        {
